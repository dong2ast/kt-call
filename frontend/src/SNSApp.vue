        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="notificationLists"
                        to="/notifications/notificationLists"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'ReportDetail', 
                description: 'report detail을 관리하는 화면입니다.', 
                key: 'reportDetails', 
                route: '/mgmts/reportDetails',
                ImageUrl: '',
            },
            { 
                title: 'NotificationList', 
                description: 'notification list을 관리하는 화면입니다.', 
                key: 'notificationLists', 
                route: '/notifications/notificationLists',
                ImageUrl: '',
            },
            { 
                title: 'SearchPhone', 
                description: 'search phone을 관리하는 화면입니다.', 
                key: 'searchPhones', 
                route: '/phones/searchPhones',
                ImageUrl: '',
            },
