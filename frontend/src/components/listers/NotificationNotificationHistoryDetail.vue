<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="From" v-model="item.from" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="To" v-model="item.to" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Platform" v-model="item.platform" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
